...
const (
	...
	FieldIpMax           = 1
	FieldCountry         = 2  // 国家
	FieldProvince        = 3  // 省会或直辖市（国内）
	FieldCity            = 4  // 地区或城市 （国内）
	FieldOrganization    = 5  // 学校或单位 （国内）
	FieldNetwork         = 6  // 运营商
	FieldLat             = 7  // 纬度
	FieldLng             = 8  // 经度
	FieldTimeZone        = 9  // 时区
	FieldUTC             = 10 // UTC
	FieldRegionalismCode = 11 // 中国行政区划代码
	FieldPhoneCode       = 12 // 国际电话代码
	FieldCountryCode     = 13 // 国家二位代码
	FieldContinentCode   = 14 // 世界大洲代码
	FieldEnd             = 15
)
